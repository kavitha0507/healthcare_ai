      ...
      if (isBMIRequest) {
        ...
        try {
          ...
          if (lowerInput.includes('hello') || lowerInput.includes('hi') || lowerInput.includes('hey')) {
            ...
            botText = "Healthy breakfast options: 1) Greek yogurt with berries and granola - protein + antioxidants 2) Oatmeal with nuts and seeds - fiber + healthy fats 3) Whole grain toast with avocado and egg - complex carbs + protein 4) Smoothie with spinach, banana, protein powder - nutrients on-the-go 5) Overnight oats with chia seeds - prepare ahead option. Aim for 15-25g protein and 5-10g fiber. What type of breakfast do you prefer?";
          ...
          } else if (lowerInput.includes('austin specialists') || lowerInput.includes('austin doctors') || (lowerInput.includes('specialists') && lowerInput.includes('austin'))) {
            botText = "Top Austin Healthcare Specialists: 🏥 **Dell Medical School** - Comprehensive care, 512-471-4900 🏥 **Ascension Seton** - Multi-specialty network, 512-324-1000 🏥 **St. David's Healthcare** - Leading specialists, 512-544-0211 🧠 **Neurology**: Dr. Sarah Johnson (Dell Seton) - Stroke & epilepsy ❤️ **Cardiology**: Dr. Michael Chen (St. David's) - Heart disease specialist 🦴 **Orthopedics**: Dr. Robert Garcia (Austin Ortho) - Sports medicine 🧬 **Oncology**: Dr. Emily White (UT Austin) - Cancer care 👶 **Pediatrics**: Dr. James Brown (Austin Children's) - Child specialists 👁️ **Ophthalmology**: Dr. Lisa Park (Austin Eye) - Vision care 🦷 **Dental**: Dr. Mark Wilson (Austin Dental) - General dentistry Need appointments? Most accept insurance and have telehealth options!";
